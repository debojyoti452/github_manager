...
class DetailsVM @Inject constructor() : ViewModel() {
    ...
    private val _detailsModel: MutableLiveData<TrendingDataModel> = MutableLiveData()
    val detailsModel: LiveData<TrendingDataModel> = _detailsModel

    fun setDetailsModel(model: TrendingDataModel) {
        _detailsModel.value = model
    }
}
